...
const Checkout: React.FC = () => {
  ...
  const { cart, cartTotal, customer, addTransaction, clearCart } = usePOS();
    ...
    return (
      <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6">
        <div className="text-center space-y-6 animate-scale-in">
          ...
          <div className="bg-card rounded-2xl p-6 w-full max-w-xs">
          ...
          <button
            ...
            className="w-full max-w-xs h-14 bg-foreground text-background font-semibold rounded-2xl hover:opacity-90 transition-all"
          >
            New Order
          </button>
        </div>
